...
Add custom tools under `dr_mcp/app/tools/`.

Example:

```python
# dr_mcp/app/tools/my_custom_tool.py
...
To add startup or shutdown behavior, edit the existing `ServerLifecycle` class in `dr_mcp/app/core/server_lifecycle.py`.
