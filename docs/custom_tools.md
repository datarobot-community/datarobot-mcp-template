...
Add your custom tools in `dr_mcp/app/recipe/tools/`:
...
```python
# dr_mcp/app/recipe/resources/my_resource.py
from app.base.core.mcp_instance import dr_mcp_resource

@dr_mcp_resource(uri="custom://my-data")
...
```python
# dr_mcp/app/recipe/prompts/my_prompt.py
from app.base.core.mcp_instance import dr_mcp_prompt
...
```python
# dr_mcp/app/recipe/core/server_lifecycle.py
from app.base.core.dr_mcp_server import ServerLifecycle
