    ...
    for search_dir in [current_dir, current_dir.parent, current_dir.parent.parent]:
        ...
        if app_core_dir.exists():
            ...
            try:
                ...
                from app.core.server_lifecycle import ServerLifecycle  # noqa: F401
                from app.core.user_config import get_user_config  # noqa: F401
                from app.core.user_credentials import get_user_credentials  # noqa: F401
