...
@pytest.fixture
def valid_metadata():
    """Valid external deployment metadata."""
    return {
        "name": "weather_api",
...
class TestDrumMetadataAdapter:
    ...
    def test_drum_adapter_input_schema_property(
        self, drum_adapter, drum_metadata_unstructured
    ):
    ...
    def test_drum_adapter_raises_on_unsupported_target_type(
...
class TestDefaultMetadataAdapter:
    ...
    def test_default_adapter_unsupported_methods_raise_error(
        self, valid_metadata, method
    ):
    ...
    def test_default_adapter_input_schema_property(
        self, default_adapter, valid_metadata
    ):
        """Test input_schema property extraction."""
    ...
    @pytest.mark.parametrize(
        ...
        [
            pytest.param(
                "base_url", "missing required 'base_url'", id="missing_base_url"
            ),
            pytest.param(
                "endpoint", "missing required 'endpoint'", id="missing_endpoint"
            ),
