...
from base.core.dynamic_tools.register import (
...
class TestRegisterExternalTool:
    ...
    @pytest.mark.asyncio
    @patch("base.core.dynamic_tools.register.register_tools")
    async def test_register_tool_basic_config(
        ...
        assert (
            mock_register_tools.call_args.kwargs["description"]
    ...
    @pytest.mark.asyncio
    @patch("base.core.dynamic_tools.register.register_tools")
    async def test_register_tool_with_tags(
        self, mock_register_tools, basic_tool_config, mock_tool
    ):
    ...
    @pytest.mark.asyncio
    @patch("base.core.dynamic_tools.register.register_tools")
    async def test_register_post_tool(
        self, mock_register_tools, post_tool_config, mock_tool
    ):
