...
from base.core.dynamic_tools.deployment.adapters.drum import (
    DrumTargetType,
    get_default_schema,
)
from base.core.dynamic_tools.schema import (
...
class TestCreateInputSchemaPydanticModel:
    ...
    def test_pydanic_schema_with_optional_subschema(self):
        ...
        input_model = model(
            path_params={"city": "London"}, query_params={"units": "imperial"}
        )
    ...
    def test_entire_chat_completions_schema(self):
        ...
        assert instance.json.temperature == 0.7
    ...
    def test_create_model_rejects_nested_in_query_params(self):
        ...
        with pytest.raises(
            SchemaValidationError, match="supports only flat structures"
        ):
    ...
    def test_create_model_allows_nested_in_json(self):
        ...
        input_model = model(
            json={"user": {"name": "Alice", "profile": {"bio": "Developer"}}}
        )
    ...
    def test_create_model_allows_nested_in_data(self):
        ...
        input_model = model(
            data={"upload": {"file": "content", "metadata": {"size": 1024}}}
        )
    ...
    def test_create_model_with_array_in_json(self):
        ...
        assert input_model.json.items[1].value == 2.5
    ...
    def test_create_model_rejects_unsupported_top_level_property(self):
        ...
        with pytest.raises(
            SchemaValidationError, match="unsupported top-level properties"
        ):
            create_input_schema_pydantic_model(schema)
    ...
    def test_create_model_rejects_primitive_type_for_json(self):
        ...
        schema = {
            "type": "object",
            "properties": {
                "json": {"type": "string", "description": "This should fail"}
            },
        }

        with pytest.raises(
            SchemaValidationError, match="does not support primitive type"
        ):
            create_input_schema_pydantic_model(schema)
...
class TestCreateSchemaModel:
    ...
    def test_create_simple_model(self):
        ...
        model = create_schema_model(
            name="SimpleModel", schema=schema, allow_nested=False
        )
    ...
    def test_create_model_with_array_of_strings(self):
        ...
        model = create_schema_model(
            name="ArrayModel", schema=schema, allow_nested=False
        )
    ...
    def test_create_model_with_array_of_integers(self):
        ...
        model = create_schema_model(
            name="NumbersModel", schema=schema, allow_nested=False
        )
    ...
    def test_create_model_with_nested_object_when_allowed(self):
        ...
        model = create_schema_model(
            name="NestedModel", schema=schema, allow_nested=True
        )
    ...
    def test_create_model_with_field_descriptions(self):
        ...
        model = create_schema_model(
            name="DescribedModel", schema=schema, allow_nested=False
        )
    ...
    def test_create_model_validates_types(self):
        ...
        model = create_schema_model(
            name="TypedModel", schema=schema, allow_nested=False
        )
    ...
    def test_create_model_with_default_values(self):
        ...
        model = create_schema_model(
            name="DefaultModel", schema=schema, allow_nested=False
        )
    ...
    def test_create_model_empty_schema(self):
        ...
        model = create_schema_model(
            name="EmptyModel", schema=schema, allow_nested=False
        )
