...
from base.tools.deployment_info import (
...
@patch("base.tools.deployment_info.get_sdk_client")
@pytest.mark.asyncio
...
@patch("base.tools.deployment_info.get_deployment_features")
@patch("base.tools.deployment_info.get_sdk_client")
@pytest.mark.asyncio
...
@patch("base.tools.deployment_info.get_deployment_info")
@pytest.mark.asyncio
...
async def test_get_deployment_info_custom_model() -> None:
    ...
    with patch("base.tools.deployment_info.get_sdk_client") as mock_client:
