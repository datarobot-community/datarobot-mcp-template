...
from base.core import common
from base.tools import deployment
...
async def test_list_deployments_success() -> None:
    with patch("base.tools.deployment.get_sdk_client") as mock_get_client:
...
async def test_list_deployments_error() -> None:
    with patch("base.tools.deployment.get_sdk_client", side_effect=Exception("fail")):
...
async def test_get_sdk_client_falls_back_to_env() -> None:
    ...
    with (
        ...
        patch("base.core.common.get_credentials") as mock_get_creds,
    ):
