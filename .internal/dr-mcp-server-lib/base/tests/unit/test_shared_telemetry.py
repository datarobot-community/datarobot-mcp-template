...
from base.core import telemetry
...
def test_initialize_telemetry_disabled() -> None:
    ...
    with patch("base.core.telemetry.get_config", return_value=mock_config):
...
def test_initialize_telemetry_enabled() -> None:
    ...
    with (
        patch("base.core.telemetry.get_config", return_value=mock_config),
        patch("base.core.telemetry.get_credentials", return_value=mock_credentials),
        patch("base.core.telemetry._setup_otel_exporter") as mock_exporter,
        patch("base.core.telemetry._setup_http_instrumentors") as mock_instrumentors,
