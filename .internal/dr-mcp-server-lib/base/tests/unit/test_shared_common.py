...
def test_get_sdk_client_returns_dr() -> None:
    ...
    with (
        patch("base.core.common.dr.Client") as mock_client,
        patch("base.core.common.get_credentials", return_value=mock_creds),
    ):
...
def test_get_s3_bucket_info() -> None:
    ...
    with patch("base.core.common.get_credentials", return_value=mock_creds):
