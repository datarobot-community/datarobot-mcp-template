...
from base.core.dr_mcp_server import DataRobotMCPServer
from base.core.dynamic_tools.deployment.adapters.default import Metadata
...
class TestDataRobotMCPServer:
    ...
    @patch("base.core.dr_mcp_server.get_config")
    @patch("base.core.dynamic_tools.deployment.register.get_datarobot_tool_deployments")
    @patch("base.core.dynamic_tools.deployment.register.dr.Deployment.get")
    @patch("base.core.dynamic_tools.deployment.config.get_api_client")
    @patch("base.core.dynamic_tools.deployment.config.get_mcp_tool_metadata")
    def test_run_with_dynamic_tool_registration(
        ...
        assert "tool3" in registered_tools, (
            f"tool3 missing in tools: {registered_tools}"
        )
        assert "tool4" in registered_tools, (
            f"tool4 missing in tools: {registered_tools}"
        )
    ...
    @patch("base.core.dr_mcp_server.get_credentials")
    ...
    @patch("base.core.dr_mcp_server.get_config")
    @patch("base.core.dr_mcp_server.asyncio")
    @patch("base.core.dr_mcp_server.get_credentials")
