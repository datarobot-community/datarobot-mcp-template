...
from base.core.config import MCPServerConfig, get_config
...
def test_config_defaults() -> None:
    ...
    # Import the config module to access the global _config variable
...
class TestDuplicateBehavior:
    def test_allowed_duplicate_behaviors(self) -> None:
        ...
        # as intended.
        field_info = MCPServerConfig.model_fields[
