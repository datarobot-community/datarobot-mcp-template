...
from base.core.constants import MAX_INLINE_SIZE
from base.tools import predict_realtime


@pytest.fixture()
def patch_realtime_dependencies() -> Generator[Dict[str, Any], None, None]:
    with (
        patch("base.tools.predict_realtime.get_sdk_client") as mock_get_sdk_client,
        patch("base.tools.predict_realtime.pd.read_csv") as mock_read_csv,
        patch("base.tools.predict_realtime.dr_predict") as mock_dr_predict,
        patch("base.core.utils.boto3.client") as mock_boto3_client,
        patch(
            "base.core.utils.generate_presigned_url",
