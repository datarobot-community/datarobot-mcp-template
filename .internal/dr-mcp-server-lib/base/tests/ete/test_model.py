    ...
    return ETETestExpectations(
        tool_calls_expected=[
            ToolCallTestExpectations(
                ...
                result="Error calling tool 'get_best_model': Error in get_best_model: ClientError: 404 client error: {'message': 'Not Found'}",
            ),
        ],
        llm_response_content_contains_expectations=[
            "Project not found",
    ...
    return ETETestExpectations(
        tool_calls_expected=[
            ToolCallTestExpectations(
                ...
                result="Error calling tool 'score_dataset_with_model': Error in score_dataset_with_model: ClientError: 404 client error: {'message': 'Not Found'}",
            ),
        ],
        llm_response_content_contains_expectations=[
            "error",
