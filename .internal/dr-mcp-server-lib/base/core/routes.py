...
from .dynamic_tools.deployment.controllers import (
...
def register_routes(mcp: FastMCP) -> None:
    ...
    if memory_manager:
        ...
        @mcp.custom_route(
            prefix_mount_path("/agent/{agent_id}/storage/{label}"), methods=["POST"]
        )
        ...
        @mcp.custom_route(
            prefix_mount_path("/agent/{agent_id}/storages"), methods=["GET"]
        )
        ...
        @mcp.custom_route(
            prefix_mount_path("/agent/{agent_id}/active-storage"), methods=["GET"]
        )
        ...
        @mcp.custom_route(
            prefix_mount_path("/agent/{agent_id}/active-storage"), methods=["DELETE"]
        )
    ...
    @mcp.custom_route(
        prefix_mount_path("/registeredDeployments/{deployment_id}"), methods=["PUT"]
    )
