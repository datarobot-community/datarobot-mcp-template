...
class MCPServerConfig(BaseSettings):
    ...
    tool_registration_allow_empty_schema: bool = Field(
        ...
        "tools can be registered with empty schemas for static endpoints that don't require any inputs. "
        "Disabled by default, as this is not typical use case and can hide potential issues with schema.",
    )
