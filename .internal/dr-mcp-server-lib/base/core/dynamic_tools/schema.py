...
def json_schema_to_python_type(schema_type: Union[str, List[str]]) -> Type[Any]:
...
def create_schema_model(
    ...
    for field_name, field_spec in properties.items():
        ...
        resolved_spec = (
            resolver.resolve_optional_union(field_spec) if is_optional else field_spec
        )
        ...
        default = (
            ...
            if is_required
            else (resolved_spec.get("default") or field_spec.get("default"))
        )
...
class InputSchemaPropertyHandler:
    ...
    def process_property(
        ...
        description = property_schema.get(
            "description", self.config.default_description
        )
        ...
        if schema_type and schema_type != "object":
            ...
            return Optional[python_type], Field(None, description=description)  # type: ignore[return-value]
        ...
        return Optional[model], Field(None, description=description)  # type: ignore[return-value]
