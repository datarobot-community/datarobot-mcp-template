...
from base.core.dynamic_tools.deployment.config import create_deployment_tool_config
from base.core.dynamic_tools.register import register_external_tool
from base.core.exceptions import DynamicToolRegistrationError
...
async def register_tool_of_datarobot_deployment(
    ...
    try:
        ...
        raise DynamicToolRegistrationError(
            "Registration failed. Could not create tool."
        ) from exc
