...
from fastmcp.resources import HttpResource, ResourceManager

from base.core.common import (
    get_credentials,
    get_s3_bucket_info,
    get_sdk_client,
)
from base.core.mcp_instance import dr_mcp_tool
from base.core.utils import generate_presigned_url
...
async def predict_by_file_path(
    ...
    score large amounts of data, for small amounts of data use the predict_realtime tool.
    Args:
